...
2. Set build command: `pnpm install && pnpm -C example-purify-ts-todo build`
3. Set output directory: `example-purify-ts-todo/build`
...
pnpm wrangler pages deploy build --project-name=purify-ts-todo
```
