...
2. Set build command: `pnpm install && pnpm -C example-effect-ts-todo build`
3. Set output directory: `example-effect-ts-todo/build`
...
pnpm wrangler pages deploy build --project-name=effect-ts-todo
```
